        ...
        <div class="main-content flex-1 p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-[#292929]">Tulis Postingan Baru</h1>
                ...
                <form action="{{ route('admin.writings.store') }}" method="POST">
                    ...
                    {{-- ========================================================== --}}
                    {{-- MODIFIKASI: Input Judul Disederhanakan (Dropdown Dihapus) --}}
                    {{-- ========================================================== --}}
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            value="{{ old('title') }}" placeholder="Contoh: Promo Kopi Susu Gula Aren Minggu Ini">
                        @error('title')
                    ...
                    {{-- ========================================================== --}}
                    {{-- BARU: Input Kategori Ditambahkan (Penting untuk Index) --}}
                    {{-- ========================================================== --}}
                    <div class="mb-4">
                    ...
                    {{-- Hapus <script> untuk logika title dropdown --}}
                    ...
                    <div class="mb-4 flex space-x-4">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="publisher" id="publisher"
                                ...
                                value="{{ old('publisher', auth()->user()->name ?? 'Admin Kafe') }}"> {{-- Saran: Isi otomatis --}}
                            @error('publisher')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="w-1/2">
                            ...
                            <input type="date" name="release_date" id="release_date"
                                ...
                                value="{{ old('release_date', now()->format('Y-m-d')) }}"> {{-- Saran: Isi otomatis --}}
                            @error('release_date')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
