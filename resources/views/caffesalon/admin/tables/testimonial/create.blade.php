    ...
    <body class="bg-gray-100">
        ...
        <div class="main-content flex-1 p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <form action="{{ route('admin.caffe.testimonial.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4 flex space-x-4">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ old('name') }}" placeholder="Nama pelanggan">
                            @error('name')
                        ...
                        <div class="w-1/2">
                            ...
                            <input type="text" name="role" id="role"
                                ...
                                value="{{ old('role') }}" placeholder="Contoh: Food Blogger, Pelanggan Setia">
                            @error('role')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4 flex space-x-4">
                        ...
                        <div class="w-1/2">
                            <label for="avatar" class="block text-sm font-medium text-gray-700 mb-1">Avatar/Foto
                                (Opsional)</label>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="quote" id="quote" rows="5"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cafe-accent @error('quote') border-red-500 @enderror"
                            placeholder="Tulis kutipan testimoni di sini...">{{ old('quote') }}</textarea>
                        @error('quote')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_visible" id="is_visible" value="1"
                                class="rounded border-gray-300 text-cafe-dark focus:ring-cafe-accent" checked>
