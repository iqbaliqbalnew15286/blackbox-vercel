...
@section('content')
    ...
    <head>
        ...
        <title>Tambah Gambar Galeri Salon</title>
        ...
        <div class="main-content flex-1 p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-[#292929]">Tambah Gambar Galeri Salon</h1>
                ...
                <form action="{{ route('admin.salon.gallery.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Nama Gambar -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Nama Gambar <span
                        ...
                        <!-- Upload Gambar -->
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Upload Gambar <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-salon-pink focus:border-transparent"
                            placeholder="Masukkan deskripsi gambar">{{ old('description') }}</textarea>
                    </div>
