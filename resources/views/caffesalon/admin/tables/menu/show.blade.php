            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <span
                            class="inline-block text-sm font-semibold bg-gray-200 text-gray-700 px-3 py-1 rounded-full mb-4">{{ $menu->category }}</span>
                        ...
                        <p class="text-gray-600 whitespace-pre-wrap">
                            {{ $menu->description ?? 'Tidak ada deskripsi tersedia.' }}</p>

                        <div class="mt-8 flex justify-end space-x-2">
                            <a href="{{ route('admin.caffe.menu.edit', $menu->id) }}"
                            ...
                            <form action="{{ route('admin.caffe.menu.destroy', $menu->id) }}" method="POST"
