        ...
        <div class="main-content flex-1 p-6">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-bold text-[#292929]">Tambah Layanan Salon</h1>
                ...
                <form action="{{ route('admin.salon.layanansalon.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
